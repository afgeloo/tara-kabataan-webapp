...
const AdminEvents = () => {
  ...
  useEffect(() => {
    fetch(
      "http://localhost/tara-kabataan/tara-kabataan-backend/api/events1.php"
    )
      .then((res) => res.json())
      .then((data) => {
        ...
        const updatedEvents = (data.events || []).map((event: Event) => {
          ...
          if (event.event_status === "UPCOMING") {
            if (now >= eventStartDatetime && now <= eventEndDatetime) {
              ...
              fetch(
                "http://localhost/tara-kabataan/tara-kabataan-backend/api/update_event_status.php",
                {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  body: JSON.stringify({
  ...
  const handleSave = () => {
    ...
    fetch(
      "http://localhost/tara-kabataan/tara-kabataan-backend/api/update_event.php",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleAddNewEventSave = async () => {
    ...
    try {
      const res = await fetch(
        "http://localhost/tara-kabataan/tara-kabataan-backend/api/add_new_event.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const confirmSingleDelete = async () => {
    ...
    try {
      const res = await fetch(
        "http://localhost/tara-kabataan/tara-kabataan-backend/api/delete_event.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleBulkDelete = async () => {
    try {
      const response = await fetch(
        "http://localhost/tara-kabataan/tara-kabataan-backend/api/delete_bulk_events.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const applyBulkStatus = async (newStatus: string) => {
    try {
      const response = await fetch(
        "http://localhost/tara-kabataan/tara-kabataan-backend/api/update_bulk_event_status.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
                      ...
                      <div className="admin-new-event-inner-content-modal-image">
                        ...
                        <input
                          ...
                          onChange={async (e) => {
                            ...
                            const res = await fetch(
                              "http://localhost/tara-kabataan/tara-kabataan-backend/api/add_new_event_image.php",
                              {
                                method: "POST",
                                body: formData,
                              }
